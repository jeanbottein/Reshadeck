...
> = 1.00;
uniform float Resolution < ui_type = "drag";
...
> = 2.4;
uniform float MonitorGamma < ui_type = "drag";
	ui_min = 0.0; ui_max = 4.0;
...
uniform float Overscan < ui_type = "drag";
